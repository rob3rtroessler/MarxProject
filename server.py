...
from flask import Flask, Blueprint, request, session, g, redirect, url_for, abort, render_template, flash, current_app, send_from_directory
...
# TODO copy the contents of *words.cvs into words.csv
...
def home():
    if request.method == 'POST':
        ...
        if os.path.isfile('./data/' + word + '.csv'):
            ...
            MarxCsv.do_marx('./corpus/marx_kapital01_1867.txt', word, out_directory='./data/')

        # TODO: instead of reloading page, send a callback saying to load the file!
